...
public:
  CPU(size_t MemoryLimit, bool IsPretty = false, bool EnableJIT = false,
      size_t JITHreshold = UINT64_MAX, bool InterpreterLogging = false);
  ~CPU();
  ...
  constexpr void syscall() override { Finished = true; };
